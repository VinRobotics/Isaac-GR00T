...
class Gr00tn15_inference():
    ...
    # Set EQUI_DATA_CONFIG=EquiLibero to swap the data config to the quaternion
    # + 6D pathway (rel_action=False, rot_type=quaternion).  This is only
    # compatible with --random_init in compute_equivariance_error.py since
    # the loaded checkpoint was trained with the axis-angle EquiRelLibero
    # variant.
