...
sys.path.insert(0, "/mnt/data/sftp/data/locht1/workspace/gr00t_equi_dit_robocasa")  # for gr00t imports
...
from gr00t.experiment.data_config import EquiRelRobocasa_1cam_Config as RobocasaDataConfig
...
class Gr00tClientPolicy:
    ...
    def __init__(self, model_dir=""):
        ...
        self.action_keys = ["x", "y", "z", "ax", "ay", "az", "gripper", "base_control", "mode"]
