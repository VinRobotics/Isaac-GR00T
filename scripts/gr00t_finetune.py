...
def main(config: ArgsConfig):
    ...
    data_state_rot_type = getattr(data_config_cls, "state_rot_type", "")
    ...
    state_rot_type_changed = data_state_rot_type != getattr(model.action_head.config, "state_rot_type", "")
    ...
    if action_horizon_changed or num_hand_changed or rot_type_changed or state_rot_type_changed or rel_action_changed or cross_attn_dim_changed:
        print(
            ...
            f"state_rot_type {data_state_rot_type} (was {getattr(model.action_head.config, 'state_rot_type', '')}), "
