...
torchrun --nproc_per_node=2 gr00t/experiment/launch_finetune.py \
    ...
    --num-gpus $NUM_GPUS \
    --output-dir /mnt/data/sftp/data/locht1/vr_checkpoints/gr00t_n16_vrh3_two_hands_chunk50_0903 \
    --save-total-limit 5 \
    --save-steps 10000 \
    --max-steps 50000 \
    --use-wandb \
...
torchrun --nproc_per_node=2 gr00t/experiment/launch_finetune.py \
    --base-model-path nvidia/GR00T-N1.6-3B \
    --dataset-path /mnt/data/sftp/data/locht1/vr_data/20260227_VR_H31_bodyshop_place_part2_trym_stereo_speedup1 /mnt/data/sftp/data/lo>
    --embodiment-tag NEW_EMBODIMENT \
    --modality-config-path /home/locht1/gr00t/data_config/vrh3_two_hands.py \
    --num-gpus $NUM_GPUS \
    --output-dir /mnt/data/sftp/data/locht1/vr_checkpoints/gr00t_n16_vrh3_two_hands_chunk50_0903 \
