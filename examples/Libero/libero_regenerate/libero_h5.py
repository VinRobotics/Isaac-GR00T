...
from libero_utils.config import LIBERO_FEATURES, LIBERO_ABS_QUAT_FEATURES, MIMICGEN_FEATURES
...
class SaveLerobotDataset(PipelineStep):
    ...
    def __init__(self, tasks: list[tuple[Path, Path, str]], max_episodes_per_task: int = None, dataset_type: str = "standard"):
        super().__init__()
        self.tasks = tasks
    ...
    def run(self, data=None, rank: int = 0, world_size: int = 1):
        ...
        raw_dataset = episode_loader(input_h5, max_episodes=self.max_episodes_per_task)
