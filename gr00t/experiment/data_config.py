...
class VRH3TwotHandRVTConfig(BaseDataConfig):
    video_keys = ["video.cam_head", "video.cam_virtual_head", "video.cam_virtual_leftTD", "video.cam_virtual_rightTD", "video.cam_virtual_leftBU", "video.cam_virtual_rightBU"]
    state_keys = [
        "state.left_arm",
        "state.right_arm",
        "state.left_hand",
