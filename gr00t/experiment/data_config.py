...
class VRH31LeftArm2CamForRL(BaseDataConfig):
    video_keys = ["video.cam_front", "video.cam_left"]
    state_keys = [
        "state.left_arm",
        "state.left_hand"
...
class VRH31GripperBothForRL(BaseDataConfig):
    video_keys = ["video.cam_head", "video.cam_left", "video.cam_right"]
    state_keys = [
        # "state.left_arm",
        # "state.right_arm",
...
###########################################################################################
class VRH31Gripper2ArmForRL(BaseDataConfig):
    video_keys = ["video.cam_head", "video.cam_left", "video.cam_right"]
    state_keys = [
        "state.left_shoulder",
        "state.left_elbow",
        "state.left_wrist",
        "state.left_gripper_open",
    ...
    action_keys = [
        ...
        "action.left_elbow",
        "action.left_wrist",
        "action.left_gripper_open",
        "action.right_shoulder",
        "action.right_elbow",
        "action.right_wrist",
        "action.right_gripper_open",
        "action.task_progress",
    ]
    language_keys = ["annotation.human.task_description"]
    reward_keys = [
...
class VRH31GripperBothForRLWoProgress(BaseDataConfig):
    video_keys = ["video.cam_head", "video.cam_left", "video.cam_right"]
    state_keys = [
        # "state.left_arm",
        # "state.right_arm",
...
class VRH31GripperBoth2CamForRL(BaseDataConfig):
...
DATA_CONFIG_MAP = {
    ...
    "vrh31_gripper_both_for_rl": VRH31GripperBothForRL(),
    "vrh31_gripper_both_for_rl_wo_progress": VRH31GripperBothForRLWoProgress(),
    "vrh31_gripper_2arm_for_rl": VRH31Gripper2ArmForRL(),
    "vrh31_gripper_both_exclude_task_progress": VRH31GripperBothExcludeTaskProgress(),
    "vrh31_left_arm_2cam": VRH31LeftArm2Cam(),
    "vrh31_left_arm_2cam_for_rl": VRH31LeftArm2CamForRL(),
