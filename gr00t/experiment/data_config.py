...
####################################################################################
class VRH3TwotHand1CamEquiEffortConfig(BaseDataConfig):
    video_keys = ["video.cam_front"]
    state_keys = [
        "state.left_hand",
        "state.right_hand",
    ...
    def transform(self):
        transforms = [
            ...
            GR00TTransform(
                state_horizon=len(self.observation_indices),
                action_horizon=len(self.action_indices),
                effort_horizon=len(self.effort_indices),
                max_state_dim=64,
                max_action_dim=32,
                max_effort_dim=26,
            ),
...
DATA_CONFIG_MAP = {
    ...
    "vrh3_two_hand_1_cam_equi_effort": VRH3TwotHand1CamEquiEffortConfig()
}
