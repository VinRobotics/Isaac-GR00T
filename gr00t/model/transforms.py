        ...
        for rot_idx, angle in enumerate(self._rotation_angles):
            ...
            for img_idx, img in enumerate(np_images):
                ...
                if view_idx in rotate_indices:
                    ...
                    # IMPORTANT: Must match ESCNN's counter-clockwise rotation convention
                    # ESCNN's irrep(1) rotates vectors counter-clockwise by 2π*r/N for element r
                    # Previously used -angle (clockwise) which was WRONG!
